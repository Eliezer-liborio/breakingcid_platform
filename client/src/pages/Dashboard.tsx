...
import { Shield, Activity, AlertTriangle, CheckCircle, XCircle, Loader2, Plus } from "lucide-react";
        ...
        <div className="space-y-8">
          ...
          <div>
            <h2 className="text-3xl font-bold text-foreground mb-2">
              Welcome back, <span className="text-primary glow-text">{user?.name || 'User'}</span>
            </h2>
          ...
          {statsLoading ? (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <Card className="neon-border bg-card/50 backdrop-blur">
                ...
                <CardContent>
                  <div className="text-3xl font-bold text-primary glow-text">{stats?.scans.total || 0}</div>
              ...
              <Card className="neon-border bg-card/50 backdrop-blur">
                ...
                <CardContent>
                  <div className="text-3xl font-bold text-destructive glow-text">{stats?.vulnerabilities.total || 0}</div>
                  <p className="text-xs text-muted-foreground mt-1">
              ...
              <Card className="neon-border bg-card/50 backdrop-blur">
                ...
                <CardContent>
                  <div className="text-3xl font-bold text-secondary glow-text">{stats?.scans.completed || 0}</div>
                  <p className="text-xs text-muted-foreground mt-1">
              ...
              <Card className="neon-border bg-card/50 backdrop-blur">
                ...
                <CardContent>
                  <div className="text-3xl font-bold text-accent glow-text">{stats?.vulnerabilities.critical || 0}</div>
                  <p className="text-xs text-muted-foreground mt-1">
